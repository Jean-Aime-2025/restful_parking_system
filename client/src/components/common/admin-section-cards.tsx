    ...
    <div className="grid grid-cols-1 gap-4 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">No change in slot allocation</div>
        </CardFooter>
      </Card>
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">Requests are growing this month</div>
        </CardFooter>
      </Card>
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">Compared to last week's data</div>
        </CardFooter>
      </Card>
      ...
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">Occupancy decreased slightly</div>
        </CardFooter>
      </Card>
    </div>
  );
